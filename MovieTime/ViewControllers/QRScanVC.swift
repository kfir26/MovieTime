...
//        } else {
//            self.presentSystemAlert(title: "Ops", message: "Your device does not support camera", btnTitle: "OK", action: {})
//            return
//        }
//
...
//        self.presentSystemAlert(title: "Ops", message: "QR code not compatible with Movies", btnTitle: "OK", action: {
...
//                        context.perform {
//                            if let movie = MovieCore(from: json as? [String : AnyObject], context: context){
//                                if movie.isContainsInDataBase{
//                                    DispatchQueue.main.async {
//                                        self.presentSystemAlert(title: "Ops", message: "You already have \(movie.object.title!) in your collection", btnTitle: "OK", action: {
//                                            self.refreshQRScanner()
//                                        })
//                                    }
//                                    return
...
//                                //pop current vc
//                                DispatchQueue.main.async {
//                                    self.presentSystemAlert(title: "Congratulations", message: "\(movie.object.title!) Added to your collection", btnTitle: "OK", action: {
//                                        //new movie scanned, add it to a collection
//                                        self.delegate?.didScanNewMovie(movie: movie.object)
...
//                            //cannot parse movie
//                            DispatchQueue.main.async {
//                                self.presentUncompatibleQRCodeAlert()
//                            }
//                        }
//                        return
//                    }
